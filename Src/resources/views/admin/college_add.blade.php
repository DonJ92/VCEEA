...
@section('title', trans('admin_college.add_title'))
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('admin_college.add_title') }}</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ trans('admin_college.add_title') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-content mt-2">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="post" action="{{ route('admin.college.add.submit') }}" class="wizard-horizontal">
                                            @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="{{ trans('admin_college.name') }}">
                                                                @error('name')
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code"  value="{{ old('code') }}" placeholder="{{ trans('admin_college.code') }}">
                                                                @error('code')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('national_code') is-invalid @enderror" name="national_code" value="{{ old('national_code') }}" id="national_code" placeholder="{{ trans('admin_college.national_code') }}">
                                                                @error('national_code')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('addr_province') is-invalid @enderror" id="addr_province" name="addr_province" onchange="onChangeProvince();">
                                                                    ...
                                                                    @foreach($province_list as $province_info)
                                                                        <option value="{{ $province_info['id'] }}" @if($province_info['id'] == old('addr_province')) selected @endif> {{ $province_info['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('addr_province')
                                                                    <span class="invalid-feedback" role="alert">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('addr_city') is-invalid @enderror" id="addr_city" name="addr_city">
                                                                    ...
                                                                    @foreach($city_list as $city_info)
                                                                        <option value="{{ $city_info['id'] }}" @if($city_info['id'] == old('addr_city')) selected @endif> {{ $city_info['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('addr_city')
                                                                    <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('addr_detail') is-invalid @enderror" id="addr_detail" name="addr_detail" value="{{ old('addr_detail') }}" placeholder="{{ trans('admin_college.addr_detail') }}">
                                                                @error('addr_detail')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('site_url') is-invalid @enderror" id="site_url" name="site_url" value="{{ old('site_url') }}" placeholder="{{ trans('admin_college.site_url') }}">
                                                                @error('site_url')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description') }}" placeholder="{{ trans('admin_college.description') }}">
                                                                @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
