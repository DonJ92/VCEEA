...
@section('title', trans('admin_plan.add_title'))
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ trans('admin_plan.add_title') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-content mt-2">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="post" action="{{ route('admin.plan.add.submit') }}" class="wizard-horizontal">
                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('subject') is-invalid @enderror" id="subject" name="subject">
                                                                    ...
                                                                    @foreach($subject_list as $subject_info)
                                                                        <option value="{{ $subject_info['id'] }}" @if(old('subject') == $subject_info['id']) selected @endif> {{ $subject_info['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('subject')
                                                                    <span class="invalid-feedback" role="alert">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('re_subject') is-invalid @enderror" id="re_subject" name="re_subject">
                                                                    <option></option>
                                                                    @foreach($subject_list as $subject_info)
                                                                        <option value="{{ $subject_info['id'] }}" @if(old('re_subject') == $subject_info['id']) selected @endif> {{ $subject_info['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('re_subject')
                                                                    <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control @error('academic_year') is-invalid @enderror" id="academic_year" name="academic_year" value="{{ old('academic_year') }}" placeholder="{{ trans('admin_plan.academic_year') }}">
                                                                @error('academic_year')
                                                                <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control @error('cost') is-invalid @enderror" id="cost" name="cost" value="{{ old('cost') }}" placeholder="{{ trans('admin_plan.cost') }}">
                                                                @error('cost')
                                                                <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control @error('recruitment_num') is-invalid @enderror" id="recruitment_num" name="recruitment_num" value="{{ old('recruitment_num') }}" placeholder="{{ trans('admin_plan.recruitment_num') }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('description') is-invalid @enderror" id="score" name="description"  value="{{ old('description') }}" placeholder="{{ trans('admin_plan.description') }}">
                                                                @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
