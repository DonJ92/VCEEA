...
@section('title', trans('admin_score.add_title'))
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('admin_score.add_title') }}</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.score') }}">{{ trans('admin_score.title') }}</a></li>
                                    <li class="breadcrumb-item active">{{ trans('admin_score.add_title') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-content mt-2">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="post" action="{{ route('admin.score.add.submit') }}" class="wizard-horizontal">
                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('batch_title') is-invalid @enderror" id="batch_title" name="batch_title">
                                                                    ...
                                                                    @foreach($batch_list as $batch_info)
                                                                        <option value="{{ $batch_info['id'] }}" @if(old('batch_title') == $batch_info['id']) selected @endif> {{ $batch_info['title'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('batch_title')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('college_name') is-invalid @enderror" id="college_name" name="college_name">
                                                                    ...
                                                                    @foreach($college_list as $college_info)
                                                                        <option value="{{ $college_info['id'] }}" @if(old('college_name') == $college_info['id']) selected @endif> {{ $college_info['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('college_name')
                                                                    <span class="invalid-feedback" role="alert">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('department_name') is-invalid @enderror" id="department_name" name="department_name">
                                                                    ...
                                                                    @foreach($department_list as $department_info)
                                                                        <option value="{{ $department_info['id'] }}" @if(old('department_name') == $department_info['id']) selected @endif> {{ $department_info['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control @error('major_name') is-invalid @enderror" id="major_name" name="major_name">
                                                                    ...
                                                                    @foreach($major_list as $major_info)
                                                                        <option value="{{ $major_info['id'] }}" @if(old('major_name') == $major_info['id']) selected @endif> {{ $major_info['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('major_name')
                                                                    <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('user_code') is-invalid @enderror" id="user_code" name="user_code" value="{{ old('user_code') }}" placeholder="{{ trans('admin_score.user_code') }}">
                                                                @error('user_code')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control @error('score') is-invalid @enderror" id="score" name="score"  value="{{ old('score') }}" placeholder="{{ trans('admin_score.score') }}">
                                                                @error('score')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('ranking') is-invalid @enderror" name="ranking" value="{{ old('ranking') }}" id="ranking" placeholder="{{ trans('admin_score.ranking') }}">
                                                                @error('ranking')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control @error('min') is-invalid @enderror" id="min" name="min"  value="{{ old('min') }}" placeholder="{{ trans('admin_score.min') }}">
                                                                @error('min')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control @error('max') is-invalid @enderror" id="max" name="max"  value="{{ old('max') }}" placeholder="{{ trans('admin_score.max') }}">
                                                                @error('max')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control @error('average') is-invalid @enderror" id="average" name="average"  value="{{ old('average') }}" placeholder="{{ trans('admin_score.average') }}">
                                                                @error('average')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
